...
Build a convolutional neural network to classify images of letters from American Sign Language hand gestures and then converting the batch of images to audio.

BATCH OF HAND GESTURE'S IMAGES --> RECOGNISED TEXT --> AUDIO
